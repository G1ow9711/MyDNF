...
- [x] **Step 3: Implement types and rules**
...
- [x] **Step 4: Implement migration-safe validation**
...
- [x] **Step 1: Write failing combat scaling tests**
...
- [x] **Step 2: Run RED test selection**
...
- [x] **Step 3: Carry and apply difficulty**
...
- [x] **Step 4: Run GREEN combat tests**
...
- [x] **Step 1: Write failing reducer and rendering tests**
...
- [x] **Step 3: Implement mounted preparation flow**
...
- [x] **Step 4: Implement keyboard flow**
...
- [x] **Step 5: Run GREEN UI tests and build**
...
- [x] **Step 1: Update the shared keyboard entry helper**
...
- [x] **Step 2: Add a real difficulty/fatigue scenario**
...
- [x] **Step 3: Run focused browser acceptance**
