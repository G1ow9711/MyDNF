...
describe("real browser computed style regressions", () => {
  ...
  it("uses flowing-light-chain phase animations for the player and weapon in the browser cascade", async () => {
    ...
    expect(computed.open.skillVfx.bladeEchoes.animationName).toBe("flowing-chain-open-echoes");
    ...
    expect(computed["dance-left"].skillVfx.bladeEchoes.animationName).toBe("flowing-chain-dance-left-echoes");
    ...
    expect(computed["dance-right"].skillVfx.bladeEchoes.animationName).toBe("flowing-chain-dance-right-echoes");
    ...
    expect(computed.cross.skillVfx.cutGrid.animationName).toBe("flowing-chain-cross-cut-grid");
    ...
    expect(computed.finish.skillVfx.finisherWave.animationName).toBe("flowing-chain-finish-sword-wave");
    expect(computed.finish.skillVfx.groundShear.animationName).toBe("flowing-chain-finish-ground-shear");
