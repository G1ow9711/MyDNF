...
- Current Liuli skill progress: `liuli-rain` now has a strict scheduled three-wave target-locked script: cast frame only queues waves, HP/status changes happen at 260/355/450 ms, monster interruption clears pending waves, and target-bound glass-rain VFX remains verified.
