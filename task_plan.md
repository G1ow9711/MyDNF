...
- Current next-candidate note: the known defensive fallback set is now covered (`anvil-guard`, `molten-wall`, `black-furnace-aegis`). Next strict-combat work should move to remaining generic non-defense skills, broader target-bound VFX coverage, enemy chain patterns, and save/resource migration.
