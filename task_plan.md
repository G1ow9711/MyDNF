...
- Current next-candidate note: remaining fallback skills are defensive Iron/Guardian-style skills (`anvil-guard`, `molten-wall`, `black-furnace-aegis`). Their next implementation should handle shield-mode player motion selectors plus strict guard/shield startup windows.
