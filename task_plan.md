...
- Current next-candidate note: remaining fallback defensive Iron/Guardian-style skill is `black-furnace-aegis`. Its next implementation should reuse delayed shield-status scheduling, shield-mode player motion selectors, and strict startup windows with stronger aegis VFX.
