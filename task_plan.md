...
- Current next-candidate notes: parallel audits selected flowing-light-chain target impact browser VFX, broader target-impact duration hardening, and large-frame same-tick hitstop priority as the next strict combat/VFX candidates.
