...
- Current next-candidate note: remaining fallback skills are defensive Iron/Guardian-style skills (`molten-wall`, `black-furnace-aegis`). Their next implementation should reuse delayed shield-status scheduling, shield-mode player motion selectors, and strict startup windows.
